...
var G__36488 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__36488;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__36489 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__36489,ch);
...
if(("\\" === ch__$1)){
var ch_36490__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_36490__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_36490__$2);
} else {
}

var G__36491 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__36491;
continue;
}
}
...
var vec__36499 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36499,(0),null);
var start_column = cljs.core.nth.call(null,vec__36499,(1),null);
...
var G__36502 = cljs.core.conj_BANG_.call(null,a,form);
a = G__36502;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__36503 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__36504 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__36504);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__36503);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__36505 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__36508 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36508,(0),null);
var end_column = cljs.core.nth.call(null,vec__36508,(1),null);
...
var vec__36514 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36514,(0),null);
var end_column = cljs.core.nth.call(null,vec__36514,(1),null);
...
var vec__36517 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36517,(0),null);
var start_column = cljs.core.nth.call(null,vec__36517,(1),null);
...
var vec__36520 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36520,(0),null);
var end_column = cljs.core.nth.call(null,vec__36520,(1),null);
...
var sb = (function (){var G__36523 = (new goog.string.StringBuffer());
G__36523.append(initch);
...
var G__36525 = (function (){var G__36524 = sb;
G__36524.append(ch);
...
G__36530.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__36530;
})();
var G__36534 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__36533;
ch = G__36534;
continue;
...
break;
default:
var G__36535 = (function (){var G__36531 = sb;
G__36531.append(ch);

return G__36531;
})();
var G__36536 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__36535;
ch = G__36536;
continue;
...
var vec__36537 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36537,(0),null);
var end_column = cljs.core.nth.call(null,vec__36537,(1),null);
...
var vec__36540 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36540,(0),null);
var column = cljs.core.nth.call(null,vec__36540,(1),null);
...
var vec__36545 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36545,(0),null);
var column = cljs.core.nth.call(null,vec__36545,(1),null);
...
var vec__36550 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36550,(0),null);
var column = cljs.core.nth.call(null,vec__36550,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__36555 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36555,(0),null);
var start_column = cljs.core.nth.call(null,vec__36555,(1),null);
...
var vec__36558 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36558,(0),null);
var end_column = cljs.core.nth.call(null,vec__36558,(1),null);
...
var G__36561 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__36561,true,null,opts,pending_forms);
...
var G__36562 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__36562)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__36562)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__36562)){
...
var _STAR_suppress_read_STAR__orig_val__36563 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__36564 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__36564);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__36563);
}});
...
var G__36565 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__36565,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__36565,rdr,first_line);
...
var G__36569 = matched;
var G__36570 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__36569;
finished = G__36570;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__36571 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__36572 = (function (){var or__5043__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__36572);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__36571);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__36573 = cljs.tools.reader.arg_env;
var arg_env_temp_val__36574 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__36574);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__36575 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__36575,"(");
...
var G__36576 = (i + (1));
var G__36577 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5043__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__36573);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__36578 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__36578);
...
var G__36579 = cljs.core.next.call(null,s__$1);
var G__36580 = ret;
s__$1 = G__36579;
r = G__36580;
continue;
...
var G__36581 = cljs.core.next.call(null,s);
var G__36582 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__36581;
key_vals = G__36582;
continue;
} else {
...
var vec__36587 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36587,(0),null);
var start_column = cljs.core.nth.call(null,vec__36587,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__36590 = token;
var G__36590__$1 = (((G__36590 == null))?null:cljs.core.subs.call(null,G__36590,(1)));
var G__36590__$2 = (((G__36590__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__36590__$1));
var G__36590__$3 = (((G__36590__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__36590__$2));
var G__36590__$4 = (((G__36590__$3 == null))?null:cljs.core.symbol.call(null,G__36590__$3));
if((G__36590__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__36590__$4);
}
})():(function (){var G__36591 = token;
var G__36591__$1 = (((G__36591 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__36591));
if((G__36591__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__36591__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__36592 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36592,(0),null);
var end_column = cljs.core.nth.call(null,vec__36592,(1),null);
...
}catch (e36601){if((e36601 instanceof Error)){
var e = e36601;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__36605,reader){
var map__36606 = p__36605;
var map__36606__$1 = cljs.core.__destructure_map.call(null,map__36606);
var opts = map__36606__$1;
var eof = cljs.core.get.call(null,map__36606__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1668256488236
