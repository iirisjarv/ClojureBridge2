...
return cljs.core.reduce.call(null,(function (result,p__31950){
...
var vec__31954 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__31954,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__31954,(1),null);
var ab = cljs.core.nth.call(null,vec__31954,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_31960 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_31960.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_31961 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_31961.call(null,a,b);
}
});
...
return (function (){var G__31965 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31965__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1668256485649
