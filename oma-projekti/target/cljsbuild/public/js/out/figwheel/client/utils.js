...
return (new CustomEvent(event_name,(function (){var obj36818 = ({"detail":data});
return obj36818;
})()));
} else {
...
var f = (function (){var pred__36825 = cljs.core._EQ_;
var expr__36826 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36825.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36826))){
return (function (p1__36819_SHARP_){
return console.warn(p1__36819_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36825.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36826))){
return (function (p1__36820_SHARP_){
return console.debug(p1__36820_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36825.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36826))){
return (function (p1__36821_SHARP_){
return console.error(p1__36821_SHARP_);
});
} else {
return (function (p1__36822_SHARP_){
return console.log(p1__36822_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36829){
var map__36830 = p__36829;
var map__36830__$1 = cljs.core.__destructure_map.call(null,map__36830);
var opts = map__36830__$1;
var eval_fn = cljs.core.get.call(null,map__36830__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__36831_SHARP_){
return new_def.callback(p1__36831_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__36832){
var vec__36833 = p__36832;
var ky = cljs.core.nth.call(null,vec__36833,(0),null);
var v = cljs.core.nth.call(null,vec__36833,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1668256488465
