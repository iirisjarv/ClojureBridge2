...
var o30479 = temp__5802__auto__;
var temp__5802__auto____$1 = (o30479["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o30480 = temp__5802__auto____$1;
return (o30480["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29837__auto__ = f;
return (o__29837__auto__["toString"]).call(o__29837__auto__);
} else {
return "";
}
}catch (e30481){var _ = e30481;
return "";
}});
...
try{var o__29837__auto___30483 = t;
(o__29837__auto___30483["cljs$lang$ctorPrWriter"]).call(o__29837__auto___30483,t,writer);
}catch (e30482){var __30484 = e30482;
}
...
var char_code = (function (){var o__29837__auto__ = (new String(char$));
return (o__29837__auto__["charCodeAt"]).call(o__29837__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29837__auto__ = String;
return (o__29837__auto__["fromCharCode"]).call(o__29837__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30485 = num_code;
switch (G__30485) {
case (1):
return (185);
...
var o__29837__auto__ = String;
return (o__29837__auto__["fromCharCode"]).call(o__29837__auto__,superscript_code);
});
/**
...
}catch (e30487){var _e__29844__auto__ = e30487;
return false;
}})())){
...
var vec__30488 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30488,(0),null);
...
var len__5766__auto___30497 = arguments.length;
var i__5767__auto___30498 = (0);
while(true){
if((i__5767__auto___30498 < len__5766__auto___30497)){
args__5772__auto__.push((arguments[i__5767__auto___30498]));

var G__30499 = (i__5767__auto___30498 + (1));
i__5767__auto___30498 = G__30499;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30493){
var vec__30494 = p__30493;
var ns_detector = cljs.core.nth.call(null,vec__30494,(0),null);
...
var G__30500 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30501 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30500;
remaining_tokens = G__30501;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30491){
var G__30492 = cljs.core.first.call(null,seq30491);
var seq30491__$1 = cljs.core.next.call(null,seq30491);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30492,seq30491__$1);
}));
...
var vec__30505 = cljs.core.split_with.call(null,(function (p1__30504_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30504_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30505,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30505,(1),null);
...
var vec__30511 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30511,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30511,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30514 = cljs.core.rest.call(null,remaining_tokens);
var G__30515 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30514;
name_tokens = G__30515;
continue;
} else {
...
var vec__30518 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30518,(0),null);
var arity = cljs.core.nth.call(null,vec__30518,(1),null);
var vec__30521 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30521,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30521,(1),null);
var vec__30524 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30524,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30524,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30524,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30524,(3),null);
...
var vec__30530 = result;
var munged_ns = cljs.core.nth.call(null,vec__30530,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30530,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30530,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30530,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30530,(4),null);
var arity = cljs.core.nth.call(null,vec__30530,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__30534 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__30534,(0),null);
var args = cljs.core.nth.call(null,vec__30534,(1),null);
var vec__30537 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30537,(0),null);
var name = cljs.core.nth.call(null,vec__30537,(1),null);
...
var G__30540 = (arity + (1));
var G__30541 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30542){
var vec__30543 = p__30542;
var arity = cljs.core.nth.call(null,vec__30543,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30543,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30546_SHARP_){
return cljs.core.get.call(null,arities,p1__30546_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__30547_SHARP_){
return cljs.core.drop.call(null,(2),p1__30547_SHARP_);
}),sorted_infos);
...
var args__5772__auto__ = [];
var len__5766__auto___30554 = arguments.length;
var i__5767__auto___30555 = (0);
while(true){
if((i__5767__auto___30555 < len__5766__auto___30554)){
args__5772__auto__.push((arguments[i__5767__auto___30555]));

var G__30556 = (i__5767__auto___30555 + (1));
i__5767__auto___30555 = G__30556;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30550){
var vec__30551 = p__30550;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30551,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30548){
var G__30549 = cljs.core.first.call(null,seq30548);
var seq30548__$1 = cljs.core.next.call(null,seq30548);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30549,seq30548__$1);
}));
...
var G__30557 = arg;
var G__30557__$1 = (((G__30557 instanceof cljs.core.Keyword))?G__30557.fqn:null);
switch (G__30557__$1) {
...
var map__30559 = options;
var map__30559__$1 = cljs.core.__destructure_map.call(null,map__30559);
var include_ns_QMARK_ = cljs.core.get.call(null,map__30559__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30559__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30559__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30559__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30560 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30560,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30560,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30560,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30560,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30560,(4),null);
var arity = cljs.core.nth.call(null,vec__30560,(5),null);
...
var o__29837__auto__ = f;
return (o__29837__auto__["getBasis"]).call(o__29837__auto__);
});
/**
...
}catch (e30563){var _e__29844__auto__ = e30563;
...
var G__30564 = (obj[cljs.core.first.call(null,path)]);
var G__30565 = cljs.core.rest.call(null,path);
obj = G__30564;
path = G__30565;
continue;
} else {
...
var _STAR_ = (function (accum,p__30566){
var vec__30567 = p__30566;
var bit = cljs.core.nth.call(null,vec__30567,(0),null);
var protocol = cljs.core.nth.call(null,vec__30567,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30570){
var vec__30571 = p__30570;
var ns = cljs.core.nth.call(null,vec__30571,(0),null);
var name = cljs.core.nth.call(null,vec__30571,(1),null);
var selector = cljs.core.nth.call(null,vec__30571,(2),null);
...
var post_process = (function (p__30575){
var vec__30576 = p__30575;
var munged_name = cljs.core.nth.call(null,vec__30576,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30576,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30574_SHARP_){
return (obj[cljs.core.first.call(null,p1__30574_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1668256484720
