...
var map__36316 = top_item;
var map__36316__$1 = cljs.core.__destructure_map.call(null,map__36316);
...
}catch (e36315){var _e = e36315;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___36317 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___36317)){
var seen_errors_36318 = temp__5802__auto___36317;
if(cljs.core.truth_(seen_errors_36318.has(self))){
} else {
seen_errors_36318.add(self);

var temp__5804__auto___36319 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___36319)){
var sense_36320 = temp__5804__auto___36319;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_36320)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1668256487693
