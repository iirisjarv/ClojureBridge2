...
var G__29253 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__29253,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__29257 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__29257,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__29258__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__29258 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__29259__i < G__29259__a.length) {G__29259__a[G__29259__i] = arguments[G__29259__i + 0]; ++G__29259__i;}
  args = new cljs.core.IndexedSeq(G__29259__a,0,null);
} 
return G__29258__delegate.call(this,args);};
G__29258.cljs$lang$maxFixedArity = 0;
G__29258.cljs$lang$applyTo = (function (arglist__29260){
var args = cljs.core.seq(arglist__29260);
return G__29258__delegate(args);
});
...
var G__29261 = props;
var G__29261__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__29261,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29261);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__29261__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__29262 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__29262,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__29262;
}
})(),id_class);
...
var G__29263 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29263) {
case (0):
...
var vec__29265 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29265,(0),null);
var id = cljs.core.nth.call(null,vec__29265,(1),null);
var className = cljs.core.nth.call(null,vec__29265,(2),null);
...
var temp__5808__auto___29268 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___29268 == null)){
} else {
var key_29269 = temp__5808__auto___29268;
(jsprops.key = key_29269);
}
...
var temp__5808__auto___29270 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___29270 == null)){
} else {
var key_29271 = temp__5808__auto___29270;
(jsprops.key = key_29271);
}
...
var temp__5808__auto___29272 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___29272 == null)){
} else {
var key_29273 = temp__5808__auto___29272;
(jsprops.key = key_29273);
}
...
var temp__5808__auto___29274 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___29274 == null)){
} else {
var key_29275 = temp__5808__auto___29274;
(jsprops.key = key_29275);
}
...
var temp__5808__auto___29276 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___29276 == null)){
} else {
var key_29277 = temp__5808__auto___29276;
(jsprops.key = key_29277);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__29278_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__29278_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__29279 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__29279,(0),null);
var derefed = cljs.core.nth.call(null,vec__29279,(1),null);
...
break;
default:
var G__29284 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__29285 = compiler;
v = G__29284;
compiler = G__29285;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template29289 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template29289 = (function (opts,id,fn_to_element,parse_fn,meta29290){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template29289.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29291,meta29290__$1){
var self__ = this;
var _29291__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template29289(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta29290__$1));
}));

(reagent.impl.template.t_reagent$impl$template29289.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29291){
var self__ = this;
var _29291__$1 = this;
return self__.meta29290;
}));

(reagent.impl.template.t_reagent$impl$template29289.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template29289.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template29289.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template29289.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template29289.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template29289.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta29290","meta29290",1796339484,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template29289.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template29289.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template29289");

(reagent.impl.template.t_reagent$impl$template29289.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template29289");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template29289.
 */
reagent.impl.template.__GT_t_reagent$impl$template29289 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template29289(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta29290){
return (new reagent.impl.template.t_reagent$impl$template29289(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta29290));
});

}

return (new reagent.impl.template.t_reagent$impl$template29289(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1668256483833
